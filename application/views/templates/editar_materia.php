                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="codigo_materia" name="codigo_materia" value="{$materia.codigo_materia}">
                        </div>
						
						<div class="form-group">
                            <label for="id_cuenta">Nombre materia:</label>
                            <input type="text" class="form-control" id="nombre_materia" name="nombre_materia" value="{$materia.nombre_materia}">
                        </div>
