    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-12">
			    ...
			    {foreach item=profesor from=$profesores}
                    <!-- Lista informacion encuesta --->
                    <div class="panel panel-primary">
                        
                        <div class="panel-body">
                            <h3 class="underlined"><b>{$profesor.nombre_profesor}</b></h3>
                            <br />
                            <h4><b>Carrera:</b> {$profesor.carrera_profesor}</h4>
                        </div>
                        
                        <div class="panel-footer no-vertical-padding">
                            <div class="row">
                                <div class="col-sm-4 side-padding-zero">
                                    <a href="/tpiencuesta/index.php/editarprofesor/index/{$profesor.id_profesor}" class="btn btn-primary btn-block btn-lg no-rounded-corner">Editar profesor</a>
                                </div>
                                <div class="col-sm-4 side-padding-zero">
