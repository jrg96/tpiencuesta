  ...
  <body>
    ...
    <div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-xs-6">
				<a href="/tpiencuesta/index.php/crearevaluacion/index/{$profesor.id_profesor}" class="btn btn-success btn-block btn-md">Crear evaluacion</a>
			</div>
			<div class="col-md-3 col-xs-6">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h4>Evaluaciones realizadas a: {$profesor.nombre_profesor}</h4>
				{foreach item=evaluacion from=$evaluaciones}
                    <!-- Lista informacion encuesta --->
                    <div class="panel panel-primary">
                        
                        <div class="panel-body">
                            <h3 class="underlined"><b>{$evaluacion.nombre_evaluacion}</b></h3>
                            <br />
                            <h4><b>Materia:</b> {$evaluacion.nombre_materia}</h4>
                        </div>
                        
                        <div class="panel-footer no-vertical-padding">
                            <div class="row">
                                <div class="col-sm-4 side-padding-zero">
                                    <a href="/tpiencuesta/index.php/editarevaluacion/index/{$evaluacion.id_evaluacion}" class="btn btn-primary btn-block btn-lg no-rounded-corner">Editar informacion general</a>
                                </div>
								<div class="col-sm-4 side-padding-zero">
                                    <a href="/tpiencuesta/index.php/editarcontenidoevaluacion/index/{$evaluacion.id_evaluacion}" class="btn btn-primary btn-block btn-lg no-rounded-corner">Editar contenido evaluacion</a>
                                </div>
								<div class="col-sm-4 side-padding-zero">
                                    <a href="/tpiencuesta/index.php/mostrarestadisticasevaluacion/index/{$evaluacion.id_evaluacion}" class="btn btn-primary btn-block btn-lg no-rounded-corner">Ver estadisticas</a>
                                </div>
                            </div>
                        </div>
                    </div>
